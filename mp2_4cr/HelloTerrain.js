...
function setupShaders() {
  ...
  shaderProgram.uniformFlag = gl.getUniformLocation(shaderProgram, "uFlag");
}
...
function setupBuffers() {
    myTerrain = new Terrain(1024,-0.5,0.5,-0.5,0.5);
    myTerrain.loadBuffers();
    // myPromise = asyncGetFile("colorHMBIG.png");
    // // We define what to do when the promise is resolved with the then() call,
    // // and what to do when the promise is rejected with the catch() call
    // myPromise.then((retrievedText) => {
    //     myTerrain.setupTextures();
...
function draw() { 
    ...
    if(document.getElementById("prebaked").checked)
        gl.uniform1i(shaderProgram.uniformFlag, 0);
    if(document.getElementById("shading").checked) {
        gl.uniform1i(shaderProgram.uniformFlag, 1);
    }
    if(document.getElementById("shading2").checked)
        gl.uniform1i(shaderProgram.uniformFlag, 2);
